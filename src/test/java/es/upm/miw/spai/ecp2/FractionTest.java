...
public class FractionTest {
    ...
    public void testEsEquivalente() {
        Fraction equivalente = new Fraction(4, 12);
        Fraction noEquivalente = new Fraction(5, 12);
        assertTrue(this.ft.esEquivalente(equivalente));
        assertFalse(this.ft.esEquivalente(noEquivalente));
    }
